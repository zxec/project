...
class View
{
    ...
    {
        if ($sort == $a) {
            return '<a class="active" href="/Main/sort/' . $b . '">' . $title . ' <i class="fas fa-solid fa-sort-up"></i></a>';
        } elseif ($sort == $b) {
            return '<a class="active" href="/Main/sort/' . $a . '">' . $title . ' <i class="fas fa-solid fa-sort-down"></i></a>';
        } else {
