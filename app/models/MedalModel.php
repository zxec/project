...
class MedalModel extends CreateDeleteModel
{
    ...
    public function getData(): array
    {
        ...
        $data['medals'] = ORM::forTable($this->tableName)
            ->selectMany(['id' => 'medals.id', 'medals.country_id', 'country_name' => 'countries.name', 'medals.type_medal_id', 'sport_name' => 'sports.name', 'type' => 'type_medals.name', 'athlete_name' => 'athletes.name'])
            ->leftOuterJoin('countries', ['countries.id', '=', 'medals.country_id'])
            ->leftOuterJoin('sports', ['sports.id', '=', 'medals.sport_id'])
            ->leftOuterJoin('type_medals', ['type_medals.id', '=', 'medals.type_medal_id'])
        ...
        $data['type_medals'] = ORM::forTable('type_medals')->orderByAsc('name')->findArray();
    ...
    public function create($medalType = null, $countryId = null, $sportId = null, $athletes = null): void
    {
        ...
        $medal->type_medals_id = $medalType;
